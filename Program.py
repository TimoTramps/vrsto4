...
#presteje stevilo oken, ki ustrezajo nekemu hevristicnemu pogoju
...
def main():
    ...
    # Ta proker potrebujemo za ustvarjanje novih
    # NAOqi modulov in uporabo obstojecih modulov
    # Broker mora ostati ziv do konca delovanja programa
    myBroker = ALBroker("myBroker",
       "0.0.0.0",   # poslusaj kogar koli
       0,           # najdi prva prosta vrata in jih uporabi
       pip,         # IP ocetovskega brokerja
       pport)       # vrata ocetovskega brokerja

    # Spremenljivka mora biti globalna spremenljivka
    # Ime konstruktorja mora biti enako imenu spremenljivke
